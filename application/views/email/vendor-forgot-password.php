...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  ...
  */
    ...
    <body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0">
        <!--*|IF:MC_PREVIEW_TEXT|*-->
        <!--[if !gte mso 9]><!----><span class="mcnPreviewText" style="display:none; font-size:0px; line-height:0px; max-height:0px; max-width:0px; opacity:0; overflow:hidden; visibility:hidden; mso-hide:all;">Vendor Forgot Password</span><!--<![endif]-->
        <!--*|END:IF|*-->
        <center>
                ...
                <table style="max-width:100%; min-width:100%;" class="mcnTextContentContainer" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                    <tbody><tr>
                        ...
                        <td class="mcnTextContent" style="padding: 0px 18px 9px; text-align: center;" valign="top">
                            ...
                            <span style="font-size:18px"><a target="_blank">Customer Registration</a></span>
                        </td>
                    </tr>
                </tbody></table>
        <!--[if mso]>
...
<br>
You have asked to reset your shaadibaraati vendor account password. Please click the below button to enter a new password.<br>
&nbsp;
                        </td>
                    </tr>
                </tbody></table>
