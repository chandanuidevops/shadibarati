                        ...
                        <div class="row  result-item-box">
                            <div class="cat-row-heding">
                                <div class="col m6 s12">
                                    <a href="<?php echo base_url().'vendors/'.$this->uri->segment(2).'/'.$clink ?>">
                                        <h4>
                                            <?php echo '<img src="'.base_url().$value->icon.'" class="responsive-img" alt="'.$value->category.'">'.$value->category ?></h4>
                                    </a>
                                </div>
                                <div class="col m6 s6 right-align hide-on-small-only">
                                    <a href="<?php echo base_url().'vendors/'.$this->uri->segment(2).'/'.$clink ?>" class="borderd-btn">View All <i class="material-icons">arrow_forward</i></a>
                                </div>
                            </div>
                                                ...
                                                <div class="row m0">
                                                    ...
                                                    <div class="col s12 m5">
                                                        ...
                                                        <p class="m0 r-crd-location">
                                                            <?php echo (!empty($vendr->city))?$vendr->city:'' ?>
                                                        </p>
                                                    </div>
