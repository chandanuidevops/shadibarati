                  ...
                  <div class="form-container">
                    <table class="bordered">
                      <tbody>
                        ...
                        <tr class="bg1" >
                          <td colspan="2" style="border-bottom: 2px solid black;">Alternate No :
                            <?php echo (!empty($result['alt_phone']))?$result['alt_phone']:''; ?>
                          </td>
                          <td style="border-bottom: 2px solid black;">City :
                            <?php echo (!empty($result['city']))?$result['city']:''; ?>
                          </td>
                        </tr>
                        <tr>
                          <td colspan="3" class="empty-pad"></td>
                        </tr>
                        <tr class="bg1">
                        ...
                        <tr class="bg1" >
                          <td colspan="2" style="border-bottom: 2px solid black;">Listing City :
                            <?php echo (!empty($result['city']))?$result['city']:''; ?>
                          </td>
                          <td style="border-bottom: 2px solid black;">Tenure :
                            <?php
                        ...
                        <tr>
                          <td class="empty-pad" colspan="3"></td>
                        </tr>
                        <tr class="bg1">
                        ...
                        <tr class="bg1" >
                          <td colspan="2" style="border-bottom: 2px solid black;">Payment Date :
                            <?php echo (!empty($result['pay_date']))?$result['pay_date']:''; ?>
                          </td>
                          <td style="border-bottom: 2px solid black;">Amount :
                        ...
                        <tr class="bg1">
                          <td colspan="2" style="border-bottom: 2px solid black;">Payment Date : <?php echo (!empty($value->date))?$value->date:''; ?></td>
                          <td style="border-bottom: 2px solid black;">Amount : <?php echo (!empty($value->amount))?$value->amount:''; ?></td>
                        </tr>
                        <?php }} ?>
                      </table>
                      <table class="terms">
