              ...
              <div id="sidemenu-include">
               ...
               <div class="col m12 s12 l9">
                  <div class="main-bar">
                    ...
                    <div class="row">
                                <div class="col 12 m6">
                                    <p class="h5-para black-text m0">Category Content</p>
                                </div>
                                <div class="col 12 m6 right-align">
                                    <a href="<?php echo base_url('content/add')  ?>" class="waves-effect waves-light btn green darken-4 white-text hoverable "><i class="fas fa-plus left"></i> Add New Content</a>
                                </div>
                            </div>
                     ...
                     <div class="shorting-table">
                        <div>
                           <div class="col l12 m12 s12">
                              <div class="">
                                 <p class="h5-para-p2">Manage Category Content</p>
                                    ...
                                    if (!empty($result)) { $count = 0;
                                      ...
                                      <tr>
                                          <td ><?php echo (!empty($result))?$count:'---'  ?></td>
                                            <td ><?php 
                                            if (!empty($value->city_id) && $value->city_id=='all') {
                                              echo "All City";
                                            ...
                                            <td ><?php if (!empty($value->category_id) && $value->category_id=='all') {
                                              echo "All Category";
                                            ...
                                            <td class="action-btn  center-align">
                                              ...
                                              <!-- view user -->
                                                <a href="<?php echo base_url('content/edit/'.$value->uniq.'') ?>"  class="blue hoverable"><i class="fas fa-edit "></i></i></a>
                                           
                                              <!-- delete user -->
                                                <a onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo base_url('content/delete/'.$value->uniq.'') ?> " class="red hoverable delete-btn"><i class="fas fa-trash  "></i></a>
                                                <!-- delete user -->
                                            </td>
