              ...
              <div id="sidemenu-include">
               ...
               <div class="col m12 s12 l9">
                  <div class="main-bar">
                    ...
                    <div class="row">
                                <div class="col 12 m6">
                                    <p class="h5-para black-text m0">Wedding</p>
                                </div>
                                <div class="col 12 m6 right-align">
                                    <a href="<?php echo base_url('real-wedding/add')  ?>" class="waves-effect waves-light btn green darken-4 white-text hoverable "><i class="fas fa-plus left"></i> ADD Wedding</a>
                                </div>
                            </div>
                     ...
                     <div class="shorting-table">
                        <div>
                           <div class="col l12 m12 s12">
                              <div class="">
                                 <p class="h5-para-p2">Manage Wedding</p>
                                <table id="dynamic" class="striped">
                                    <thead>
                                       <tr class="tt">
                                          <th id="a" class="h5-para-p2" width="50px">Sl No.</th>
                                          <th id="b" class="h5-para-p2" width="100px">Image</th>
                                          <th id="c" class="h5-para-p2" width="120px">Name</th>
                                    ...
                                    <?php  if (!empty($result)) { $count = 0; foreach ($result as $key => $value) { $count = $count+1; ?>
                                      ...
                                      <td ><?php echo (!empty($result))?$count:'---'  ?></td>
                                            ...
                                            <td ><?php echo (!empty(date('d M, Y' , strtotime($value->date))))?date('d M, Y' , strtotime($value->date)):'---'  ?></td>
                                          
                                            <td class="action-btn  center-align">
                                            <a href="<?php echo base_url('real-wedding/view/'.$value->id.'') ?>"  class="blue hoverable"><i class="fas fa-eye "></i></a>
                                              <!-- view user -->
                                                <a href="<?php echo base_url('real-wedding/edit/'.$value->id.'') ?>"  class="blue hoverable"><i class="fas fa-edit "></i></i></a>
                                              <!-- view user -->
                                              <!-- delete user -->
                                                <a onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo base_url('weding/deleteReal/'.$value->id.'') ?> " class="red hoverable delete-btn"><i class="fas fa-trash  "></i></a>
                                                <!-- delete user -->
                                            </td>
