              ...
              <div id="sidemenu-include">
               ...
               <div class="col m12 s12 l9">
                  <div class="main-bar">
                    ...
                    <div class="row">
                                <div class="col 12 m6">
                                    <p class="h5-para black-text m0">Vendor Package Request</p>
                                </div>
                            </div>
                     <!-- shorting -->
                     <div class="shorting-table">
                        <div>
                           <div class="col l12 m12 s12">
                              <div class="">
                                 <p class="h5-para-p2">Package List</p>
                                <table id="dynamic" class="striped">
                                    ...
                                    if (!empty($result)) {
                                      ...
                                      <tr>
                                            ...
                                            <td ><a href="<?php echo base_url('vendor-package/view/'.$value->ids.'') ?>"><?php echo $this->ci->m_venquiry->categoryName($value->category);  ?></a></td>
                                            <td><a href="<?php echo base_url('vendor-package/view/'.$value->ids.'') ?>"><?php echo (!empty($value->date))?date("M d, Y ", strtotime($value->date)):'---'; ?></a></td>
                                            <td class="action-btn  center-align">
                                              <!-- view user -->
                                                <a href="<?php echo base_url('vendor-package/view/'.$value->ids.'') ?>"  class="blue hoverable"><i class="fas fa-eye "></i></i></a>
                                              <!-- view user -->
                                            </td>
