                            ...
                            <div class="card">
                                <div class="card-content">
                                    <div class="form-container">
                                        <form action="<?php echo base_url() ?>banner-package/insert" method="post" style="overflow-y: auto;overflow-x: hidden;" id="city-form" enctype="multipart/form-data">
                                          ...
                                          <div class="row m0">
                                                ...
                                                <div class="input-field col s12 l6">
                                                  <input type="text" id="page" name="page" class="validate" required>
                                            ...
                                            <div class="row m0">
                                              <div class="input-field col s12 l6">
                                                  <input type="text" id="pack1" name="pack1" class="validate">
                                                  <label for="pack1">Pack 1 <span class="red-text">*</span></label>
                                                </div>
                                                <div class="input-field col s12 l6">
                                                  <input type="text" id="pack2" name="pack2" class="validate">
                                            ...
                                            <div class="row m0">
                                                <div class="input-field col s12 l6">
                                                  <input type="text" id="limit" name="limit" class="validate" >
                                                  <label for="limit">Limit <span class="red-text">*</span></label>
                                                </div>
                                                <div class="input-field col s12 l6">
                                                  <input type="text" id="tenure" name="tenure" class="validate" >
