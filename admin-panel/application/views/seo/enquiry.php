                                ...
                                <table id="dynamic" class="striped">
                                    <thead>
                                       <tr class="tt">
                                          ...
                                          <th id="g" class="h5-para-p2" width="62px">Phone</th>
                                          <th id="g" class="h5-para-p2" width="62px">Wed Plan</th>
                                          <th id="g" class="h5-para-p2" width="62px">Wed Budget</th>
                                          <th id="g" class="h5-para-p2" width="62px">Service</th>
                                          <th id="g" class="h5-para-p2" width="62px">Wed Date</th>
                                       </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    <?php if (!empty($result)) { $count = 0; foreach ($result as $key => $value) { $count = $count+1; ?>
                                      <tr>
                                        ...
                                        <td ><?php if (!empty($value->wedplan) && $value->wedplan=='1') {
                                          echo 'Full Wedding Planning';
                                        }else if (!empty($value->wedplan) && $value->wedplan=='2'){
                                          echo 'Partial Planning';
                                        }  ?></td>

                                        <td ><?php if (!empty($value->wedbudget) && $value->wedbudget=='1') {
                                          echo 'Less than ₹ 15L';
                                        }else if (!empty($value->wedbudget) && $value->wedbudget=='2'){
                                          echo '₹ 15L - 30L';
                                        }else if (!empty($value->wedbudget) && $value->wedbudget=='3'){
                                          echo '₹ 30L - 60L';
                                        }else if (!empty($value->wedbudget) && $value->wedbudget=='4'){
                                          echo 'More than ₹ 60L';
                                        }   ?></td>

                                        <td ><?php echo (!empty($value->service))?$value->service:'---'  ?></td>

                                        <td ><?php echo date('d M, y', strtotime($value->weddate))  ?></td>
                                        </tr>
                                    <?php } } ?>
                                    </tbody>
                                 </table>
