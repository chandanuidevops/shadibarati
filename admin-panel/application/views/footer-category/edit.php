        ...
        <section class="sec-top">
            ...
            $(function() {
                $('#marqueeplus1').on('click', function(e) {
                    e.preventDefault();
                    $('<div class="row m0 marqaddnext1"> <div class="input-field col s12 l5"><input type="text" id="type" name="type[]" class="validate"><label for="type">Type </label> </div> <div class="input-field col s12 l5"> <input type="text" id="type" name="type[]" class="validate"> <label for="type">Type </label> </div><br> <div class="col l2"> <a id="brandplus" class="marqueeplus1 remov"><i class="fa fa-times" aria-hidden="true"></i></a> </div> </div>')
            ...
            $(function() {
                $('#marqueeplus2').on('click', function(e) {
                    e.preventDefault();
                    $('<div class="row m0 marqaddnext1"> <div class="input-field col s12 l5"><input type="text" id="vcategory" name="vcategory[]" class="validate" required> <label for="vcategory">Category </label> </div> <div class="input-field col s12 l5"> <input type="text" id="vcategory" name="vcategory[]" class="validate" required> <label for="vcategory">Category </label> </div><br> <div class="col l2"> <a id="brandplus1" class="marqueeplus2 remov"><i class="fa fa-times" aria-hidden="true"></i></a> </div> </div>')
            ...
            $(function() {
             ...
             $('.marqueeclose.remov').on('click', function(e) {
                e.preventDefault();
                $(this).closest('div.row.sides').remove();
                var id = $(this).attr('value');
                if (!confirm("Are you sure you want to delete this item?")) {
                    return false;
                } else {
                    $.ajax({
                        url: "<?php echo base_url();?>f_category/deleteInfo",
                        type: "get",
                        data: {
                            "id": id,
                        },
