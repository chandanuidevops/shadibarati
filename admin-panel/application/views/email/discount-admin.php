...
<!--[if (mso)|(IE)]><td align="center" width="600" style="background-color:#FFFFFF;width:600px; border-top: 0px solid #A17A7A; border-left: 0px solid #000000; border-bottom: 1px solid #ABA3A3; border-right: 0px solid #786C6C;" valign="top"><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 0px; padding-left: 20px; padding-top:5px; padding-bottom:5px;"><![endif]-->
<div class="col num12" style="min-width: 320px; max-width: 600px; display: table-cell; vertical-align: top; width: 600px;">
<div style="width:100% !important;">
<!--[if (!mso)&(!IE)]><!-->
<div style="border-top:0px solid #A17A7A; border-left:0px solid #000000; border-bottom:1px solid #ABA3A3; border-right:0px solid #786C6C; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 20px;">
<!--<![endif]-->
...
<div style="font-size:1px;line-height:25px"> </div><img alt="Image" border="0" class="left fixedwidth" src="<?php echo base_url()?>assets/img/logo.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%; max-width: 203px; display: block;" title="Image" width="203"/>
...
<p style="font-size: 22px; line-height: 1.2; mso-line-height-alt: 26px; margin: 0;"><span style="font-size: 22px;">Vendor Discount Request</span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<p style="font-size: 14px; line-height: 1.5; mso-line-height-alt: 21px; margin: 0;">New Vendor Discount Request has been Submitted from the  <b><?php echo  $emp->name ?></b> , Details are mentioned below.</p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<div style="width:100% !important;">
<!--[if (!mso)&(!IE)]><!-->
<div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:0px; padding-bottom:px; padding-right: 0px; padding-left: 0px;">
<!--<![endif]-->
                 ...
                 <tr style="border-collapse:collapse;"> 
                  <td width="560" valign="top" align="center" style="padding:0;Margin:0;"> 
                   <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;border-color:#EFEFEF;border-style:solid;border-width:0px;border-radius:3px;background-color:#FFFFFF;padding-bottom: 30px;padding-left: 30px;" width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffffff"> 
                     ...
                     <tr style="border-collapse:collapse;"> 
                      <th align="left" style="Margin: 0; padding-left: 20px; padding-right: 10px; padding-top: 20px; padding-bottom: 0px; width: 100px;">Vendor</th> 
                     ...
                     <th align="left" style="Margin: 0; padding-left: 20px; padding-right: 10px; padding-top: 20px; padding-bottom: 0px; width: 100px;">Category</th>
                      <td align="left" style="Margin:0;padding-left:10px;padding-right:10px;padding-top:20px;padding-bottom:0px;"><?php echo (!empty($result['category']))?': &nbsp;'.$this->ci->m_vendors->getCategory($result['category']):''; ?></td> 
                     </tr>
                     <tr style="border-collapse:collapse;"> 
                     <th align="left" style="Margin: 0; padding-left: 20px; padding-right: 10px; padding-top: 20px; padding-bottom: 0px; width: 100px;">City</th>
                      <td align="left" style="Margin:0;padding-left:10px;padding-right:10px;padding-top:20px;padding-bottom:0px;"><?php echo (!empty($result['city']))?': &nbsp;'.$this->ci->m_vendors->getCity($result['city']):''; ?></td> 
                     </tr>
                     <tr style="border-collapse:collapse;"> 
                     <th align="left" style="Margin: 0; padding-left: 20px; padding-right: 10px; padding-top: 20px; padding-bottom: 0px; width: 100px;">Discount %</th>
                      <td align="left" style="Margin:0;padding-left:10px;padding-right:10px;padding-top:20px;padding-bottom:0px;"><?php echo (!empty($result['discount']))?': &nbsp;'.$result['discount'].'%':''; ?></td> 
                     </tr>
                     <tr style="border-collapse:collapse;"> 
                     <th align="left" style="Margin: 0; padding-left: 20px; padding-right: 10px; padding-top: 20px; padding-bottom: 0px; width: 100px;">Package</th>
                      <td align="left" style="Margin:0;padding-left:10px;padding-right:10px;padding-top:20px;padding-bottom:0px;"><?php echo (!empty($result['package']))?': &nbsp;'.$this->ci->m_vendors->packageName($result['package']):''; ?></td> 
                     </tr>
                     <tr style="border-collapse:collapse;"> 
                     <th align="left" style="Margin: 0; padding-left: 20px; padding-right: 10px; padding-top: 20px; padding-bottom: 0px; width: 100px;">Added By</th>
                      <td align="left" style="Margin:0;padding-left:10px;padding-right:10px;padding-top:20px;padding-bottom:0px;width: 200px;"><?php echo (!empty($emp->name))?': &nbsp;'.$emp->name:''; ?></td> 
                     </tr>
                     

                     <?php if($emp->admin_type == '3'){ ?>
                      <tr style="border-collapse:collapse;"> 
                     <th align="left" style="Margin: 0; padding-left: 20px; padding-right: 10px; padding-top: 20px; padding-bottom: 0px; width: 100px;">Employee Type</th>
                      <td align="left" style="Margin:0;padding-left:10px;padding-right:10px;padding-top:20px;padding-bottom:0px;width: 200px;"><?php if($emp->admin_type == '3'){ echo ': &nbsp;Executive'; }else if($emp->admin_type == '2') { echo ': &nbsp; Manager'; } ?></td> 
                     </tr>
                     
                         <tr style="border-collapse:collapse;"> 
                         <th align="left" style="Margin: 0; padding-left: 20px; padding-right: 10px; padding-top: 20px; padding-bottom: 0px; width: 100px;">Manager</th>
                          <td align="left" style="Margin:0;padding-left:10px;padding-right:10px;padding-top:20px;padding-bottom:0px;width: 200px;"><?php echo ': &nbsp;'.$manager->name; ?></td> 
                         </tr>

                         <tr style="border-collapse:collapse;"> 
                         <th align="left" style="Margin: 0; padding-left: 20px; padding-right: 10px; padding-top: 20px; padding-bottom: 0px; width: 100px;">Manager Discount %</th>
                          <td align="left" style="Margin:0;padding-left:10px;padding-right:10px;padding-top:20px;padding-bottom:0px;width: 200px;"><?php echo ': &nbsp;'.$manager->discount.'%'; ?></td> 
                         </tr>
...
<p style="font-size: 12px; line-height: 1.2; mso-line-height-alt: 17px; margin: 0;">© <?php echo date('Y') ?> <a href="<?php echo $this->config->item('web_url')?>" style="color: white;"> Shaadi baraati </a> All rights reserved.</p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
