      ...
      <div id="sidemenu-include">
                <?php $this->load->view('include/menu.php'); ?>
                        ...
                        <div class="col m12 s12 l9">
                            <p class="h5-para black-text ">Add City</p>

                            <div class="card">
                                <div class="card-content">
                                    <div class="form-container">
                                        <form action="<?php echo base_url() ?>cities/insert" method="post" style="overflow-y: auto;overflow-x: hidden;" id="city-form" enctype="multipart/form-data">
                                        
                                          <div class="row m0">
                                                <div class="input-field col s12 l6">
                                                  <input type="text" id="city" name="city" class="validate" required value="<?php echo (!empty($setting)?$setting['name']:'') ?>">
                                            ...
                                            <div class="row m0">
                                              ...
                                              <input type="hidden" name="city_id" value="<?php echo random_string('alnum',10) ?>">
