...
<p style="font-size: 22px; line-height: 1.2; mso-line-height-alt: 26px; margin: 0;"><span style="font-size: 22px;">Free Quote Request</span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<p style="font-size: 14px; line-height: 1.5; mso-line-height-alt: 21px; margin: 0;">New Free Quote Request has been Submitted from the user, Details are mentioned below.</p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
                  ...
                  <td width="560" valign="top" align="center" style="padding:0;Margin:0;"> 
                   <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;border-color:#EFEFEF;border-style:solid;border-width:0px;border-radius:3px;background-color:#FFFFFF;padding-bottom: 30px;padding-left: 30px;" width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffffff"> 
                     ...
                     <tr style="border-collapse:collapse;"> 
                      ...
                      <td align="left" style="Margin:0;padding-left:10px;padding-right:10px;padding-top:20px;padding-bottom:0px;"><?php echo (!empty($result['firstname']))?': &nbsp;'.$result['firstname'].$result['lastname']:''; ?></td> 
                     </tr> 
                     <tr style="border-collapse:collapse;"> 
                     ...
                     <th align="left" style="Margin: 0; padding-left: 20px; padding-right: 10px; padding-top: 20px; padding-bottom: 0px; width: 100px;">Service</th>
                      <td align="left" style="Margin:0;padding-left:10px;padding-right:10px;padding-top:20px;padding-bottom:0px;"><?php echo (!empty($result['service']))?': &nbsp;'.$result['service']:''; ?></td> 
                     </tr>
                     <tr style="border-collapse:collapse;"> 
                     ...
                     <tr style="border-collapse:collapse;"> 
                     <th align="left" style="Margin: 0; padding-left: 20px; padding-right: 10px; padding-top: 20px; padding-bottom: 0px; width: 100px;">Budget</th>
                      <td align="left" style="Margin:0;padding-left:10px;padding-right:10px;padding-top:20px;padding-bottom:0px;"><?php echo (!empty($result['budget']))?': &nbsp;'.date("M d, Y ", strtotime($result['budget'])):''; ?></td> 
                     </tr>
                     <tr style="border-collapse:collapse;"> 
